        ...
        <div className="space-y-5">
          <section className={`rounded-xl p-5 shadow-sm ${cardClass}`}>
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-3 flex flex-wrap gap-3">
                  <button className="rounded-lg bg-[#d9a63d] px-4 py-2 text-xs font-semibold text-black">
                    Upload New
                  </button>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <div className={`flex h-10 items-center rounded-lg px-3 ${fieldClass}`}>
                  <input className="w-full bg-transparent text-sm outline-none" placeholder="Julian Pierce" />
                </div>
              </div>
              <div>
                ...
                <div className={`flex h-10 items-center gap-2 rounded-lg px-3 ${fieldClass}`}>
                  ...
                  <input className="w-full bg-transparent text-sm outline-none" placeholder="jpierce@nexus.ai" />
                </div>
              </div>
              <div>
                ...
                <div className={`flex h-10 items-center gap-2 rounded-lg px-3 ${fieldClass}`}>
                  ...
                  <input className="w-full bg-transparent text-sm outline-none" placeholder="+1 (555) 123-4567" />
                </div>
              </div>
              <div>
                <label className="mb-2 block text-xs font-semibold">Role / Position</label>
                <div className={`flex h-10 items-center rounded-lg px-3 ${fieldClass}`}>
                  <input className="w-full bg-transparent text-sm outline-none" placeholder="Senior System Administrator" />
                </div>
              </div>
            </div>
            ...
            <div className="mt-5 flex justify-end gap-3">
              ...
              <button className="h-9 rounded-lg bg-[#d9a63d] px-5 text-xs font-semibold text-black">
                Save Profile
              </button>
            </div>
          </section>
...
<section className={`rounded-xl p-5 shadow-sm ${cardClass}`}>
        ...
        <aside className="space-y-5">
          <section className="rounded-xl bg-[#d9a63d] p-5 text-white shadow-sm">
            <div className="mb-5 flex items-center justify-between">
              <span className="rounded-full bg-black px-3 py-1 text-[10px] font-semibold text-white">Premium Plan</span>
            ...
            <div className="my-5 space-y-3 text-sm">
              {["Unlimited Projects & Seats", "Advanced Analytics & Logs", "24/7 Priority Support"].map((item) => (
            ...
            <button className="h-10 w-full rounded-xl bg-white text-sm font-semibold text-[#7a580e]">
              Manage Billing
            </button>
            <p className="mt-3 text-center text-[10px] uppercase tracking-wide text-white/70">
          ...
          <section className={`rounded-xl p-5 shadow-sm ${cardClass}`}>
            ...
            <div className="space-y-4">
              {[
                { icon: globalIcon, label: "Language", value: "English (US)" },
                { icon: clockIcon, label: "Time Zone", value: "PST (UTC -8)" },
